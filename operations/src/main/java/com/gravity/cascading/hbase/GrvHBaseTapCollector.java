 ...
 * resource managed by a particular HBaseTap instance.
 */
@SuppressWarnings("unchecked")
public class GrvHBaseTapCollector extends TupleEntrySchemeCollector implements OutputCollector {
  /** Field LOG */
  private static final Logger LOG = LoggerFactory.getLogger(GrvHBaseTapCollector.class);
  /** Field conf */
   ...
   */
  public GrvHBaseTapCollector(FlowProcess<? extends Configuration> flowProcess, Tap<Configuration, RecordReader, OutputCollector> tap) throws IOException {
    super(flowProcess, tap.getScheme());
    this.hadoopFlowProcess = (FlowProcess<JobConf>)flowProcess;
    this.tap = tap;
