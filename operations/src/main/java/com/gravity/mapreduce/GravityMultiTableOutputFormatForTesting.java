package com.gravity.mapreduce;/*             )\._.,--....,'``.
.b--.        /;   _.. \   _\  (`._ ,.
`=,-,-'~~~   `----(,_..'--(,_..'`-.;.'  */
 ...
 * {@link org.apache.hadoop.hbase.client.Put} or a {@link org.apache.hadoop.hbase.client.Delete} instance. All tables must already exist, and
...
public class GravityMultiTableOutputFormatForTesting extends OutputFormat<ImmutableBytesWritable, Mutation> {
