...
public class AlexaInfo {
    ...
    public AlexaInfo(String accessKeyId, String secretAccessKey, String site) {
     ...
     * Makes a request to the Alexa Web Information Service UrlInfo action
     */
    public static String makeRequest(String key, String secret, String siteIn) throws Exception {
...
//        }
        ...
        String accessKey = key; //args[0];
        String secretKey = secret; //args[1];
        String site = siteIn;//args[2];

        AlexaInfo alexaInfo = new AlexaInfo(accessKey, secretKey, site);

        String query = alexaInfo.buildQuery();

        String toSign = "GET\n" + SERVICE_HOST + "\n/\n" + query;

//        System.out.println("String to sign:\n" + toSign + "\n");

        String signature = alexaInfo.generateSignature(toSign);
...
//        System.out.println(xmlResponse);
    ...
    public static String rank(String key, String secret, String siteIn) throws Exception {
        String xmlString = makeRequest(key, secret, siteIn);
        Node xml = XML.loadString(xmlString);
        return xml.$bslash$bslash("Rank").text();
    }
}
