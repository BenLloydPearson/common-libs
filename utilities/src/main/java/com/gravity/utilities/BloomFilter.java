...
//  private int numberOfUniqueElements; // number of unique elements we've seen in the Bloom filter
...
//
//  /**
//   * Adds an array of bytes to the Bloom Filter but also counts
//   * how many unique items we've probably added to the bloom filter
//   * this is still just an approximation but could be useful for certain
//   * applications such as guesstimating how many unique users you saw today.
//   * added by Jim Plush
//   *
//   * @param bytes
//   */
//  public void addWithUniqueCounts(byte[] bytes) {
//
//    if (!contains(bytes)) {
...
//  }
//
//  public int uniqueElementCnt() {
//    return this.numberOfUniqueElements;
//  }
//
//  /**
