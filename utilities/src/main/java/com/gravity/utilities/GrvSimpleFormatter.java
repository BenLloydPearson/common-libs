...
public class GrvSimpleFormatter extends Formatter {

    // format string for printing the log record
    private static final String format = "%1$tH:%1$tM:%1$tS %4$-6s [%7$s] %5$s%6$s%n";
    ...
    public synchronized String format(LogRecord record) {
        ...
        String source = name;
        String shortName = ClassName$.MODULE$.simpleName(source);
        String method = "";
