...
/**
 * GrvDateMidnight defines a date where the time component is fixed at midnight.
 ...
 *
 * <p>
 * GrvDateMidnight is thread-safe and immutable, provided that the Chronology is as well.
...
public final class GrvDateMidnight
    ...
    //-----------------------------------------------------------------------
    /**
     * Obtains a {@code GrvDateMidnight} set to the current system millisecond time
     ...
     * @since 2.0
     */
    public static GrvDateMidnight now() {
        return new GrvDateMidnight();
    }
     ...
     * @since 2.0
     */
    public static GrvDateMidnight now(DateTimeZone zone) {
        if (zone == null) {
            throw new NullPointerException("Zone must not be null");
        }
        return new GrvDateMidnight(zone);
    }
     ...
     * @since 2.0
     */
    public static GrvDateMidnight now(Chronology chronology) {
        if (chronology == null) {
            throw new NullPointerException("Chronology must not be null");
        }
        return new GrvDateMidnight(chronology);
    }

    //-----------------------------------------------------------------------
    /**
     * Parses a {@code GrvDateMidnight} from the specified string.
     * <p>
     ...
     */
    @FromString
    public static GrvDateMidnight parse(String str) {
        return parse(str, ISODateTimeFormat.dateTimeParser().withOffsetParsed());
    }

    /**
     * Parses a {@code GrvDateMidnight} from the specified string using a formatter.
     *
     * @param str  the string to parse, not null
     * @param formatter  the formatter to use, not null
     * @since 2.0
     */
    public static GrvDateMidnight parse(String str, DateTimeFormatter formatter) {
        DateTime dt = formatter.parseDateTime(str);
        return new GrvDateMidnight(dt.getMillis(), dt.getChronology());
    }
     ...
     */
    public GrvDateMidnight(DateTimeZone zone) {
        super(zone);
    }
     ...
     * @see #now(Chronology)
     */
    public GrvDateMidnight(Chronology chronology) {
        super(chronology);
    }
     ...
     */
    public GrvDateMidnight(long instant) {
        super(instant);
    }
     ...
     * @param zone  the time zone, null means default zone
     */
    public GrvDateMidnight(long instant, DateTimeZone zone) {
        super(instant, zone);
    }
     ...
     * @param chronology  the chronology, null means ISOChronology in default zone
     */
    public GrvDateMidnight(long instant, Chronology chronology) {
     ...
     */
    public GrvDateMidnight(Object instant) {
     ...
     * @throws IllegalArgumentException if the instant is invalid
     */
    public GrvDateMidnight(Object instant, DateTimeZone zone) {
        super(instant, zone);
    }
     ...
     * @throws IllegalArgumentException if the instant is invalid
     */
    public GrvDateMidnight(Object instant, Chronology chronology) {
     ...
     */
    public GrvDateMidnight(int year, int monthOfYear, int dayOfMonth) {
     ...
     * @param zone  the time zone, null means default time zone
     */
    public GrvDateMidnight(int year, int monthOfYear, int dayOfMonth, DateTimeZone zone) {
     ...
     * @param chronology  the chronology, null means ISOChronology in default zone
     */
    public GrvDateMidnight(int year, int monthOfYear, int dayOfMonth, Chronology chronology) {
     ...
     */
    public GrvDateMidnight withMillis(long newMillis) {
        Chronology chrono = getChronology();
        newMillis = checkInstant(newMillis, chrono);
        return (newMillis == getMillis() ? this : new GrvDateMidnight(newMillis, chrono));
    }
     ...
     * <p>
     * This method creates a new GrvDateMidnight using the midnight millisecond value
     ...
     * GrvDateMidnight rounds down the millisecond value to get to midnight, and the
     ...
     */
    public GrvDateMidnight withChronology(Chronology newChronology) {
        return (newChronology == getChronology() ? this : new GrvDateMidnight(getMillis(), newChronology));
    }
     ...
     */
    public GrvDateMidnight withZoneRetainFields(DateTimeZone newZone) {
        ...
        return new GrvDateMidnight(millis, getChronology().withZone(newZone));
    }
     ...
     */
    public GrvDateMidnight withFields(ReadablePartial partial) {
        if (partial == null) {
            return this;
        }
     ...
     */
    public GrvDateMidnight withField(DateTimeFieldType fieldType, int value) {
        if (fieldType == null) {
     ...
     * These three lines are equivalent:
     * <pre>
     * GrvDateMidnight added = dt.withFieldAdded(DateTimeFieldType.year(), 6);
     * GrvDateMidnight added = dt.plusYears(6);
     * GrvDateMidnight added = dt.year().addToCopy(6);
     * </pre>
     *
     ...
     */
    public GrvDateMidnight withFieldAdded(DurationFieldType fieldType, int amount) {
        if (fieldType == null) {
            throw new IllegalArgumentException("Field must not be null");
        }
        if (amount == 0) {
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight withDurationAdded(long durationToAdd, int scalar) {
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight withDurationAdded(ReadableDuration durationToAdd, int scalar) {
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight withPeriodAdded(ReadablePeriod period, int scalar) {
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight plus(long duration) {
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight plus(ReadableDuration duration) {
        return withDurationAdded(duration, 1);
    }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight plus(ReadablePeriod period) {
     ...
     * <pre>
     * GrvDateMidnight added = dt.plusYears(6);
     * GrvDateMidnight added = dt.plus(Period.years(6));
     * GrvDateMidnight added = dt.withFieldAdded(DurationFieldType.years(), 6);
     * </pre>
     *
     ...
     * @since 1.1
     */
    public GrvDateMidnight plusYears(int years) {
        if (years == 0) {
            return this;
        }
     ...
     * The following three lines are identical in effect:
     * <pre>
     * GrvDateMidnight added = dt.plusMonths(6);
     * GrvDateMidnight added = dt.plus(Period.months(6));
     * GrvDateMidnight added = dt.withFieldAdded(DurationFieldType.months(), 6);
     * </pre>
     *
     ...
     * @since 1.1
     */
    public GrvDateMidnight plusMonths(int months) {
        if (months == 0) {
            return this;
        }
     ...
     * The following three lines are identical in effect:
     * <pre>
     * GrvDateMidnight added = dt.plusWeeks(6);
     * GrvDateMidnight added = dt.plus(Period.weeks(6));
     * GrvDateMidnight added = dt.withFieldAdded(DurationFieldType.weeks(), 6);
     * </pre>
     *
     ...
     * @since 1.1
     */
    public GrvDateMidnight plusWeeks(int weeks) {
        if (weeks == 0) {
            return this;
        }
     ...
     * The following three lines are identical in effect:
     * <pre>
     * GrvDateMidnight added = dt.plusDays(6);
     * GrvDateMidnight added = dt.plus(Period.days(6));
     * GrvDateMidnight added = dt.withFieldAdded(DurationFieldType.days(), 6);
     * </pre>
     *
     ...
     * @since 1.1
     */
    public GrvDateMidnight plusDays(int days) {
        if (days == 0) {
            return this;
        }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight minus(long duration) {
        return withDurationAdded(duration, -1);
    }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight minus(ReadableDuration duration) {
        return withDurationAdded(duration, -1);
    }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public GrvDateMidnight minus(ReadablePeriod period) {
        return withPeriodAdded(period, -1);
    }
     ...
     * @since 1.1
     */
    public GrvDateMidnight minusYears(int years) {
        if (years == 0) {
            return this;
        }
     ...
     * The following three lines are identical in effect:
     * <pre>
     * GrvDateMidnight subtracted = dt.minusMonths(6);
     * GrvDateMidnight subtracted = dt.minus(Period.months(6));
     * GrvDateMidnight subtracted = dt.withFieldAdded(DurationFieldType.months(), -6);
     * </pre>
     *
     ...
     * @since 1.1
     */
    public GrvDateMidnight minusMonths(int months) {
        if (months == 0) {
            return this;
        }
     ...
     * The following three lines are identical in effect:
     * <pre>
     * GrvDateMidnight subtracted = dt.minusWeeks(6);
     * GrvDateMidnight subtracted = dt.minus(Period.weeks(6));
     * GrvDateMidnight subtracted = dt.withFieldAdded(DurationFieldType.weeks(), -6);
     * </pre>
     *
     ...
     * @since 1.1
     */
    public GrvDateMidnight minusWeeks(int weeks) {
        if (weeks == 0) {
            return this;
        }
     ...
     * The following three lines are identical in effect:
     * <pre>
     * GrvDateMidnight subtracted = dt.minusDays(6);
     * GrvDateMidnight subtracted = dt.minus(Period.days(6));
     * GrvDateMidnight subtracted = dt.withFieldAdded(DurationFieldType.days(), -6);
     * </pre>
     *
     ...
     * @since 1.1
     */
    public GrvDateMidnight minusDays(int days) {
        if (days == 0) {
            return this;
        }
     ...
     * <p>
     * GrvDateMidnight is immutable, so there are no set methods.
     ...
     * @since 1.3
     */
    public GrvDateMidnight withEra(int era) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withCenturyOfEra(int centuryOfEra) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withYearOfEra(int yearOfEra) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withYearOfCentury(int yearOfCentury) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withYear(int year) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withWeekyear(int weekyear) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withMonthOfYear(int monthOfYear) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withWeekOfWeekyear(int weekOfWeekyear) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withDayOfYear(int dayOfYear) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withDayOfMonth(int dayOfMonth) {
     ...
     * @since 1.3
     */
    public GrvDateMidnight withDayOfWeek(int dayOfWeek) {
    ...
    public int getEpochSeconds() { return (int)(getMillis() / 1000); }

    //-----------------------------------------------------------------------
    /**
     * GrvDateMidnight.Property binds a GrvDateMidnight to a DateTimeField allowing powerful
     * datetime functionality to be easily accessed.
     * <p>
     * The simplest use of this class is as an alternative get method, here used to
     * get the year '1972' (as an int) and the month 'December' (as a String).
     * <pre>
     * GrvDateMidnight dt = new GrvDateMidnight(1972, 12, 3);
     ...
     * of GrvDateMidnight - they do not modify the original. The example below yields two
     * independent immutable date objects 20 years apart.
     * <pre>
     * GrvDateMidnight dt = new GrvDateMidnight(1972, 12, 3);
     * GrvDateMidnight dt20 = dt.year().addToCopy(20);
     * </pre>
     ...
     * <p>
     * GrvDateMidnight.Property itself is thread-safe and immutable.
     *
     * @author Stephen Colebourne
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        private GrvDateMidnight iInstant;
         ...
         */
        Property(GrvDateMidnight instant, DateTimeField field) {
            super();
            iInstant = instant;
            iField = field;
        }
        ...
        private void readObject(ObjectInputStream oos) throws IOException, ClassNotFoundException {
            iInstant = (GrvDateMidnight) oos.readObject();
         ...
         * @return the datetime
         */
        public GrvDateMidnight getGrvDateMidnight() {
            return iInstant;
        }

        //-----------------------------------------------------------------------
        /**
         * Adds to this field in a copy of this GrvDateMidnight.
         * <p>
         * The GrvDateMidnight attached to this property is unchanged by this call.
         * This operation is faster than converting a GrvDateMidnight to a MutableDateTime
         ...
         * @return a copy of the GrvDateMidnight with the field value changed
         * @throws IllegalArgumentException if the value isn't valid
         */
        public GrvDateMidnight addToCopy(int value) {
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public GrvDateMidnight addToCopy(long value) {
            return iInstant.withMillis(iField.add(iInstant.getMillis(), value));
        }

        /**
         * Adds to this field, possibly wrapped, in a copy of this GrvDateMidnight.
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public GrvDateMidnight addWrapFieldToCopy(int value) {
            return iInstant.withMillis(iField.addWrapField(iInstant.getMillis(), value));
        }

        //-----------------------------------------------------------------------
        /**
         * Sets this field in a copy of the GrvDateMidnight.
         * <p>
         * The GrvDateMidnight attached to this property is unchanged by this call.
         * This operation is faster than converting a GrvDateMidnight to a MutableDateTime
         * and back again when setting one field. When setting multiple fields,
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public GrvDateMidnight setCopy(int value) {
            return iInstant.withMillis(iField.set(iInstant.getMillis(), value));
        }

        /**
         * Sets this field in a copy of the GrvDateMidnight to a parsed text value.
         * <p>
         * The GrvDateMidnight attached to this property is unchanged by this call.
         * This operation is faster than converting a GrvDateMidnight to a MutableDateTime
         * and back again when setting one field. When setting multiple fields,
         ...
         */
        public GrvDateMidnight setCopy(String text, Locale locale) {
         ...
         * @throws IllegalArgumentException if the text value isn't valid
         */
        public GrvDateMidnight setCopy(String text) {
            return setCopy(text, null);
        }

        //-----------------------------------------------------------------------
        /**
         * Returns a new GrvDateMidnight with this field set to the maximum value
         * for this field.
         * <p>
         * This operation is useful for obtaining a DateTime on the last day
         * of the month, as month lengths vary.
         * <pre>
         * GrvDateMidnight lastDayOfMonth = dt.dayOfMonth().withMaximumValue();
         * </pre>
         * <p>
         * The GrvDateMidnight attached to this property is unchanged by this call.
         *
         * @return a copy of the GrvDateMidnight with this field set to its maximum
         * @since 1.2
         */
        public GrvDateMidnight withMaximumValue() {
            return setCopy(getMaximumValue());
        }

        /**
         * Returns a new GrvDateMidnight with this field set to the minimum value
         * for this field.
         * <p>
         * The GrvDateMidnight attached to this property is unchanged by this call.
         *
         * @return a copy of the GrvDateMidnight with this field set to its minimum
         * @since 1.2
         */
        public GrvDateMidnight withMinimumValue() {
            return setCopy(getMinimumValue());
        }

        //-----------------------------------------------------------------------
        /**
         * Rounds to the lowest whole unit of this field on a copy of this GrvDateMidnight.
         *
         * @return a copy of the GrvDateMidnight with the field value changed
         */
        public GrvDateMidnight roundFloorCopy() {
            return iInstant.withMillis(iField.roundFloor(iInstant.getMillis()));
        }

        /**
         * Rounds to the highest whole unit of this field on a copy of this GrvDateMidnight.
         *
         * @return a copy of the GrvDateMidnight with the field value changed
         */
        public GrvDateMidnight roundCeilingCopy() {
            return iInstant.withMillis(iField.roundCeiling(iInstant.getMillis()));
        }

        /**
         * Rounds to the nearest whole unit of this field on a copy of this GrvDateMidnight,
         * favoring the floor if halfway.
         *
         * @return a copy of the GrvDateMidnight with the field value changed
         */
        public GrvDateMidnight roundHalfFloorCopy() {
         ...
         * @return a copy of the GrvDateMidnight with the field value changed
         */
        public GrvDateMidnight roundHalfCeilingCopy() {
         ...
         * @return a copy of the GrvDateMidnight with the field value changed
         */
        public GrvDateMidnight roundHalfEvenCopy() {
