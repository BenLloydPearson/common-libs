...
class Language(val wikiCode : String, val locale : Locale)
{
    ...
    override def toString(): String = locale.toString
    ...
    override def hashCode: Int = wikiCode.hashCode
}

object Language
{
    val Default: Language = new Language("en", new Locale("en"))
     ...
     */
    val nonIsoWpCodes: Map[String, String] = Map(
